...
[![License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE) [![R](https://img.shields.io/badge/R-4.0%252B-blue.svg)](https://cran.r-project.org/)
...
-   `show_meta_data()`: Displays metadata for a given data frame, including column descriptions, units, and other relevant attributes.
...
The gecko.utils package has the possiblity to get the figure save path for the current project.
This is useful when you are working with R-Projects and want to save the figures in a specific folder.
After running the function `set_figure_save_path()` the path to the specified folder in the current project is saved in the project.
